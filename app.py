...
pm10 = st.number_input("PM10", value=st.session_state.get("pm10", 0.0), key="pm10")
pm25 = st.number_input("PM2.5", value=st.session_state.get("pm25", 0.0), key="pm25")
no2 = st.number_input("NO2", value=st.session_state.get("no2", 0.0), key="no2")
o3 = st.number_input("O3", value=st.session_state.get("o3", 0.0), key="o3")
